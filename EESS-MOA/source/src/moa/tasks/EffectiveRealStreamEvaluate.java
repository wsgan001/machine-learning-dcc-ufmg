 ...
 * @version $Revision: 1 $
 */
public class EffectiveRealStreamEvaluate extends MainTask {
    ...
    public ClassOption learnerOption = new ClassOption("learner", 'l',
            "Classifier to train.", Classifier.class, "rules.Lac");
    ...
    protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
        ...
        while (stream.hasMoreInstances()
            ...
            double predictedClass = Utils.maxIndex(prediction);
            trainInst.setClassValue(predictedClass);
            learner.trainOnInstance(trainInst);
